  ...
  test("testbench") {
    compiled.doSim { dut =>
      ...
      def apbReadAssert(
        ...
        (driver.read(address) & mask) == data,
        "Test case " + testId + " :" + message
      )
      ...
      def testSetA: Unit = {
        ...
        apbReadAssert(
          ...
          0x00000000,
          0x0000ffff,
          "TimerA clear/read value doesn't work"
        )
        ...
        apbReadAssert(
          ...
          0x0000003f,
          0x0000ffff,
          "TimerA limit read/write doesn't work"
        )
      ...
      def testSetB: Unit = {
        ...
        apbReadAssert(
          ...
          0x00000006,
          0x0000ffff,
          "TimerA external tick doesn't work"
        )
        ...
        apbReadAssert(
          ...
          0x00000000,
          0x0000ffff,
          "TimerA external clear doesn't work"
        )
      }
